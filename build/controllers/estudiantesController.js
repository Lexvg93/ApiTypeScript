...
class EstudiantesController {
    ...
    ingresar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const registro = yield estudianteModel_1.Estudiante.save(req.body);
    ...
    actualizar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield estudianteModel_1.Estudiante.update({ id: Number(id) }, req.body);
                const registroActualizado = yield estudianteModel_1.Estudiante.findOneBy({ id: Number(id) });
